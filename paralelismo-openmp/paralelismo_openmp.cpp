...
int main(){
    ...
    auto delta_to = std::chrono::high_resolution_clock::now();
    ...
    auto delta_tf = std::chrono::high_resolution_clock::now();

    std::chrono::duration<double> tempo = delta_tf - delta_to;

    std::cout << "Tempo = " << tempo.count() << std::endl;
